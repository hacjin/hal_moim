        ...
        return (
          <div id="fullpage-wrapper">
            <div className="section section1">
              <Container component="main" maxWidth="sm">
                ...
                <TextField
                  ...
                  autoFocus
                />
                <Button id="login" type="submit" fullWidth variant="contained" color="primary" className={classes.submit} onClick={login}>
                  {' '}
                  로그인{' '}
                </Button>
                ...
                <CardActionArea>
                  ...
                  <CardContent className={classes.contentColor}>
                    ...
                    <Typography variant="body2" color="textSecondary" component="p">
                      지금은 동네 친구가 필요한 순간! 같은 관심사를 가진 사람들과 소통해 보세요!
                    </Typography>
                  </CardContent>
                </CardActionArea>
                <CardActions className={classes.contentColor}>
                  <Button onClick={() => fullpageApi.moveTo(1, 0)}>로그인하기</Button>
                </CardActions>
              </Card>
              {/* </Container> */}
            </div>
            <div className="section">
              ...
              <Card className={classes.root}>
                <CardActionArea>
                  <CardMedia className={classes.media} image="https://ppss.kr/wp-content/uploads/2016/10/title_%EC%8B%9C%EB%8B%88%EC%96%B4.jpg" title="Contemplative Reptile" />
                  <CardContent className={classes.contentColor}>
                    <Typography gutterBottom variant="h5" component="h2">
                      쉽고 간편하게!
                    </Typography>
